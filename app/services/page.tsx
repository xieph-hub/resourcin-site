...
export const metadata = {
  ...
  description:
    "Specialised talent acquisition, executive search, pipelining, embedded recruiters, RPO and white-label job board solutions – designed to connect talent with opportunity.",
};
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-10 sm:px-6 sm:py-12 lg:px-8 lg:py-14">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-2 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
              Talent services that connect people, roles, and growth.
            </h1>
            <p className="mt-3 text-sm text-slate-600 sm:text-base">
              Resourcin is a human capital solutions partner focused on{" "}
              <span className="font-semibold">
                bridging the gap between talent and opportunity
              </span>
              . Whether you&apos;re filling a critical leadership role, building
              repeat pipelines, or spinning up a new market, we give you a
              pragmatic, context-aware hiring partner – not just CVs.
            </p>
          </div>
        ...
        <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-slate-600">
              For companies that care about both quality of hire and speed. We
              combine targeted sourcing, structured interviews, and honest feedback
              so you can hire with conviction – and stay aligned with your broader
              business objectives.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm text-slate-600">
                Start with a single critical role and scale up to embedded recruiters
                or full RPO pods as your hiring needs grow. The goal is simple: a
                hiring engine that matches the pace and ambition of your business.
              </p>
            </div>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-[1.5fr,1fr] md:items-center">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600">
              The same jobs experience we use for the Resourcin Talent Network can
              be turned into a branded job board for your company – or for multiple
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <ol className="mt-3 space-y-2 text-sm text-slate-600">
              <li>
                ...
                Define{" "}
                <code className="rounded bg-slate-100 px-1">tenantId</code>, brand
                settings, and URL.
              </li>
              <li>
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-4 px-4 py-8 sm:flex-row sm:items-center sm:px-6 lg:px-8">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">
              ...
              options, timelines, and a simple engagement model, anchored on our
